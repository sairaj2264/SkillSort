  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="text-center">
        ...
        <p className="text-xl text-gray-600 mb-8">Welcome to the Admin Portal</p>
                ...
                <div key={index} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">Score: <span className="font-medium text-indigo-600">{user.score}</span></p>
                    </div>
                    <a 
                      href={user.resumeUrl} 
                      target="_blank" 
